...
export const hi: Record<TKey, string> = {
  ...
  // फ़ीचर की व्याख्या रखने वाला छोटा "i"
  'info.more': 'यह क्या है?',
  'info.about': 'यह क्या है? {subject}',
  ...
  'exam.continuousOn': 'लगातार',
  'exam.continuousJoined': '+{count} जुड़े',
  'exam.continuousHint':
    'लगातार मोड: यह अनुच्छेद खत्म होने पर आपकी लाइब्रेरी का अगला अनुच्छेद इसके साथ जोड़ दिया जाता है।',
  ...
  // घड़ी शुरू होने से पहले का 3 · 2 · 1
  'countIn.title': 'तैयार हो जाइए',
  'countIn.hint': 'अपनी उँगलियाँ कीबोर्ड पर रखें। शून्य पर घड़ी चल पड़ेगी।',
  'countIn.startNow': 'अभी शुरू करें',
  'countIn.turnOff': 'बंद करने के लिए सेटिंग्स → व्यवहार।',

  // Paper mode
  'paper.heading': 'अपने काग़ज़ से टाइप करें',
  'paper.body': 'अनुच्छेद आपके सामने काग़ज़ पर है — जो पढ़ें, वही नीचे टाइप करें।',
  'paper.checkedLater':
  ...
  'result.nextFromLibrary': 'लाइब्रेरी से अगला',
  ...
  'setup.continuous': 'लगातार टाइपिंग',
  'setup.continuousHint':
    'अनुच्छेद खत्म होने पर रुकें नहीं — लाइब्रेरी का अगला अनुच्छेद जोड़कर टाइपिंग चलती रहती है, यानी रन अनुच्छेद से नहीं, घड़ी से खत्म होता है।',
  ...
  'practice.todayTime': 'आज {time} टाइपिंग',
  'practice.timeTitle': 'कीबोर्ड पर बिताया समय',
  'practice.today': 'आज',
  'practice.allTime': 'कुल',
  'practice.testCount': '{count} टेस्ट',
  'practice.perDay': 'रोज़ की टाइपिंग · पिछले {days} दिन',
  'practice.peakDay': 'सर्वश्रेष्ठ दिन {time}',
  'practice.perActiveDay': 'अभ्यास वाले दिन औसतन {time}, कुल {days} दिन अभ्यास किया।',
  'practice.noneYet': 'अभी कोई अभ्यास दर्ज नहीं — आपका पहला टेस्ट गिनती शुरू करेगा।',
  ...
  'settings.countIn': 'टेस्ट से पहले 3 · 2 · 1 गिनें',
  'settings.countInHint':
    'तीन सेकंड घड़ी रोकी जाती है, जिसमें आप उँगलियाँ कीबोर्ड पर रख लें। बंद रहने पर टेस्ट खुलते ही टाइमर चल पड़ता है।',
  ...
  'paperReport.notChecked':
    'वर्तनी जाँची नहीं गई — या तो इस भाषा के लिए शब्दकोश उपलब्ध नहीं था, या जाँच समय पर पूरी नहीं हुई। ऊपर दी गई गति, शब्द और सुधार इससे अप्रभावित हैं।',
  'paperReport.clean':
  ...
  'split.offer':
    'यह पाठ एक टेस्ट के लिए लंबा है — इसे ऐसे अनुच्छेदों में बाँटें जिन्हें आप एक-एक करके पूरा कर सकें।',
  'split.about':
    'जब तक आप चालू न करें, यह बंद रहता है — पाठ एक ही टेस्ट के रूप में चलता है। चालू करने पर उसे वाक्य के अंत पर क्रमांकित अनुच्छेदों में काटा जाता है, जो एक के बाद एक चलते हैं, और लाइब्रेरी याद रखती है आप किस अनुच्छेद तक पहुँचे — इसलिए एक अध्याय कई बैठकों में पूरा किया जा सकता है।',
  'split.aboutLength':
    'हर अनुच्छेद लगभग कितना लंबा हो। कट निकटतम वाक्य के अंत पर पड़ता है, इसलिए भागों की लंबाई थोड़ी बदलती है। Short एक वार्म-अप है; Exam असली कौशल परीक्षा जितना लंबा है।',
  'split.length': 'अनुच्छेद की लंबाई',
  'split.split': 'बाँटें',
  'split.recut': 'दूसरी लंबाई पर फिर बाँटें:',
  'split.undo': 'बाँटना पूर्ववत करें',
  'split.aboutRecut':
    'दूसरी लंबाई चुनने पर पूरा पाठ शुरू से फिर काटा जाता है, इसलिए भाग नए सिरे से क्रमांकित होते हैं और कौन-से भाग पूरे हुए थे वह रिकॉर्ड मिट जाता है। पाठ स्वयं कभी नहीं बदलता।',
  ...
  'report.title': 'समस्या बताएं',
  'report.lead':
    'बताइए क्या हुआ। यह GitHub पर एक issue के रूप में खुलेगा, जिसे आप पढ़कर स्वयं भेजते हैं — पृष्ठभूमि में कुछ नहीं जाता।',
  'report.close': 'बंद करें',
  'report.kind': 'रिपोर्ट का प्रकार',
  'report.kindBug': 'ख़राबी',
  'report.kindIdea': 'सुझाव',
  'report.kindQuestion': 'प्रश्न',
  'report.name': 'आपका नाम',
  'report.namePlaceholder': 'जिससे पता चले किसे उत्तर देना है',
  'report.required': 'आवश्यक',
  'report.message': 'क्या हुआ',
  'report.messagePlaceholder': 'आपने क्या किया, क्या अपेक्षा थी, और उसके बजाय क्या हुआ।',
  'report.messageMin': 'कम से कम {count} अक्षर — एक-दो वाक्य पर्याप्त हैं।',
  'report.messageCount': '{count} अक्षर शेष',
  'report.contact': 'ईमेल या हैंडल',
  'report.contactPlaceholder': 'केवल यदि आप GitHub के बाहर उत्तर चाहते हैं',
  'report.attached': 'आपकी रिपोर्ट के साथ भेजा जाएगा',
  'report.attachedLine':
    'Typly {version} ({build}) · इंटरफ़ेस {lang} · ब्राउज़र और रनटाइम संस्करण। कोई पैसेज, परिणाम या निजी डेटा नहीं।',
  'report.publicWarning': 'GitHub issue सार्वजनिक होता है। जो सार्वजनिक न करना चाहें, वह न लिखें।',
  'report.open': 'GitHub पर खोलें',
  'report.copy': 'रिपोर्ट कॉपी करें',
  'report.copied': 'रिपोर्ट कॉपी हो गई।',
  'report.copyFailed': 'कॉपी नहीं हो सकी — टेक्स्ट चुनकर स्वयं कॉपी करें।',
  'report.needBoth': 'आपका नाम और संदेश, दोनों ज़रूरी हैं।',
  'report.opened': 'GitHub खुल गया — वहाँ Submit दबाकर issue दर्ज करें।',
  'report.openedTrimmed':
    'GitHub खुल गया है और पूरी रिपोर्ट क्लिपबोर्ड पर है — कुछ छूट जाए तो उसे चिपका दें।',
  'report.blocked': 'ब्राउज़र ने नया टैब रोक दिया। रिपोर्ट कॉपी करें और GitHub स्वयं खोलें।',
  'report.blockedCopied':
    'ब्राउज़र ने नया टैब रोक दिया, रिपोर्ट क्लिपबोर्ड पर है — इसे नए GitHub issue में चिपका दें।',
  ...
  // मोड की जानकारी — आंकड़े कोड से आते हैं, यहाँ नहीं लिखे हैं।
  'modeInfo.standard':
    'बोर्ड के अपने नियम, जैसे प्रकाशित हुए हैं। ग़लतियाँ टाइप करते समय दिखती हैं और उतना ही काटती हैं जितना असली परीक्षा में। यहीं से शुरू करें — बाक़ी मोड कठिन परीक्षाएँ नहीं, अभ्यास के सहारे हैं।',
  'modeInfo.blind':
    'गद्यांश आपको आँकना बंद कर देता है: कोई हरा, कोई लाल, कोई कर्सर नहीं। नतीजा अंत में मिलता है। यह हर शब्द जाँचने की आदत तोड़ने की ड्रिल है, जो अधिकांश लोगों की असली गति को बाँध देती है।',
  'modeInfo.error_free':
    'ग़लत कुंजी अस्वीकार होती है — जो अक्षर गद्यांश चाहता है, उसके बिना कुछ नहीं दिखेगा। उत्तीर्णांक 100% हो जाता है, क्योंकि ग़लती टाइप ही नहीं हो सकती। इसके लिए स्क्रीन पर गद्यांश चाहिए; काग़ज़ वाला रन सामान्य मोड की तरह चलेगा।',
  'modeInfo.accuracy':
    'शुद्धता की ओर झुका हुआ: उत्तीर्ण होने के लिए ज़रूरी शुद्धता बढ़ जाती है और हर ग़लती अधिक भारी पड़ती है। केवल गति से काम नहीं चलेगा। जब आपकी ग़लतियाँ, गति नहीं, आपको फेल करती हों तो इसे चुनें।',
  'modeInfo.speed':
    'गति की ओर झुका हुआ: ज़रूरी गति बढ़ जाती है, शुद्धता की सीमा घट जाती है और ग़लतियाँ कम काटती हैं। जान-बूझकर अपनी सहज गति से ऊपर दौड़ने के लिए, जहाँ ग़लतियाँ प्रयास ख़त्म न करें।',
  'modeInfo.strict':
    'जब तक शब्द पूरी तरह सही न हो, आप आगे नहीं बढ़ सकते। शब्द के भीतर ग़लती चलेगी — उसे अगले शब्द तक ले जाना नहीं। इसके लिए Backspace और स्क्रीन पर गद्यांश चाहिए। तेज़ टाइप करके बाद में सुधारने की आदत का इलाज — वह आदत अभ्यास ऐप में पास होती है और शुद्धता वाली परीक्षा में फेल।',

  'modeInfo.changes': 'इससे क्या बदलता है',
  'modeInfo.wpmToPass': 'उत्तीर्ण गति',
  'modeInfo.kdphToPass': 'उत्तीर्ण डिप्रेशन',
  'modeInfo.accuracyToPass': 'उत्तीर्ण शुद्धता',
  'modeInfo.penalty': 'प्रति ग़लती कटौती',

  'setup.pressureNeedsCountdown':
    'प्रेशर मोड के लिए काउंटडाउन ज़रूरी है — स्टॉपवॉच पर अंत के पास चमकने वाली घड़ी के पास चमकने की कोई वजह नहीं होती। इसे चालू करने के लिए टाइमिंग को काउंटडाउन करें।',
  'setup.pacerNeedsCutoff':
    'यह बोर्ड कोई न्यूनतम गति प्रकाशित नहीं करता, इसलिए मार्कर के चलने के लिए कोई कट-ऑफ़ नहीं है।',
  ...
  // Kruti Dev converter
  // कुंजीपटल चार्ट
  'layout.title': 'कुंजीपटल लेआउट चार्ट',
  'layout.subtitle':
    'आप जिस हिंदी लेआउट पर टाइप करते हैं, उसकी दोनों परतें — जो किसी भी बिकने वाले कीबोर्ड पर छपी नहीं होतीं।',
  'layout.pickAria': 'कौन-सा लेआउट दिखाएँ',
  'layout.print': 'छापें',
  'layout.space': 'स्पेस',
  'layout.findLabel': 'अक्षर खोजें',
  'layout.findPlaceholder': 'क्ष',
  'layout.findSequence': '{letter} की अपनी कुंजी नहीं है — {keys} क्रम से दबाएँ।',
  'layout.findHit': '{letter} — {key} कुंजी पर, {finger} उँगली।',
  'layout.findMiss': '{letter} इस लेआउट की दिखाई गई परत पर नहीं है।',
  'layout.inscriptNote':
    'इनस्क्रिप्ट तार्किक क्रम में है: पहले व्यंजन, फिर उसकी मात्रा, और फ़ॉन्ट दोनों को जोड़ देता है। हर कुंजी का ऊपरी भाग शिफ़्ट से मिलता है।',
  'layout.remingtonNote':
    'रेमिंगटन गेल में ख, घ, ण, थ, ध, भ, श और ष की अपनी कुंजी नहीं है: पहले आधा रूप, फिर स्ट्रोक कुंजी — वही अक्षर पूरा करती है, और ऊपर का खोज बॉक्स दोनों कुंजियाँ बता देगा। कुंजी-स्थिति कृति देव जैसी है, पर गेल तार्किक क्रम में है, इसलिए मात्रा व्यंजन के बाद आती है। हर कुंजी का ऊपरी भाग शिफ़्ट से मिलता है; ङ और ञ AltGr परत पर हैं, जो चार्ट में नहीं है।',
  ...
  // रिलीज़ नोट्स — 0.5.0
  'changelog.redesign':
    'नया इंटरफ़ेस: ऊपर-दाएँ बॉक्स में घड़ी वाला असली परीक्षा हेडर, पैनल जो पैनल जैसे दिखें, और समूहों में बँटा साइडबार।',
  'changelog.modeInfo':
    'हर परीक्षा मोड अब स्वयं बताता है कि वह क्या करता है, और कौन-से उत्तीर्णांक बदलता है।',
  'changelog.caret':
    'टाइपिंग कर्सर अक्षरों के बीच सरकता है और टाइप करते समय स्थिर रहता है, बीच-बीच में झपकता नहीं।',
  'changelog.wpmTrace': 'आपकी WPM के नीचे जीवंत गति-रेखा, जिस पर कट-ऑफ़ खिंची होती है।',
  'changelog.resultReveal': 'परिणाम गिनते हुए बढ़ते हैं, शुद्धता एक रिंग में, और निर्णय अंत में।',
  'changelog.nextKey': 'अगली दबाने वाली कुंजी स्क्रीन-कीबोर्ड पर धड़कती है।',
  'changelog.timeDrain':
    'काउंटडाउन परीक्षा हेडर के ऊपर एक रेखा की तरह भी घटता है — गद्यांश से नज़र हटाए बिना पढ़ा जा सकता है।',
  'changelog.whyDisabled':
    'जो सेटिंग चालू नहीं हो सकती, वह अब कारण बताती है और उसे खोलने वाली सेटिंग का नाम भी।',
  'changelog.noDevTools':
    'डेस्कटॉप ऐप डेवलपर टूल्स के बिना आता है — ब्लाइंड रन जो गद्यांश छिपा रहा है, वह छिपा ही रहता है।',

  // रिलीज़ नोट्स — 0.6.0
  'changelog.reviewQueue':
    'आपकी ग़लतियों की समीक्षा-कतार: हर कमज़ोर कुंजी और शब्द शेड्यूल होता है, ताकि सुधरी चीज़ें लौटना बंद कर दें और बाक़ी लौटती रहें।',
  'changelog.passageGen':
    'चुनी हुई टाइपिंग कठिनाई पर अभ्यास गद्यांश बनाएँ — और हर परिणाम मापा जाता है, इसलिए जो कठिनाई बताई गई है वही मिलती है।',
  ...
  'tabulate.about':
    'स्कैन किए गए फ़ॉर्म और रजिस्टर OCR से ऐसे स्तंभों के रूप में निकलते हैं जो जगह (स्पेस) से अलग रखे होते हैं। उन जगहों को Tab में बदलने से पाठ एक डेटा-एंट्री टेस्ट बन जाता है, जिसमें अंक शब्द प्रति मिनट के बजाय की-डिप्रेशन प्रति घंटा में गिने जाते हैं — जैसे DEST और उस तरह के पेपर जाँचे जाते हैं। बटन दबाने तक आपके पाठ में कोई बदलाव नहीं होता।',
  ...
  // ग़लतियों की समीक्षा-कतार (core/review)
  'review.title': 'समीक्षा कतार',
  'review.dueHint': 'आज {count} की समीक्षा बाक़ी है। एक छोटी ड्रिल में निपटा दें।',
  'review.clearHint': 'आज कुछ बाक़ी नहीं। अगला बैच तैयार होने पर लौटें।',
  'review.start': 'समीक्षा शुरू करें',
  'review.due': 'बाक़ी',
  'review.learning': 'सीख रहे',
  'review.mastered': 'सध गए',
  'review.today': 'आज बाक़ी',
  'review.rung': '{of} में से {box}वाँ पायदान',
  'review.allMastered': 'सभी कार्ड सध गए। नई ग़लतियाँ नया कार्ड बनाएँगी।',
  'review.nothingToday': 'आज कुछ बाक़ी नहीं — बाक़ी विश्राम पर हैं।',
  'review.explainer':
    'हर कमज़ोरी एक कार्ड है। असली रन में सही टाइप करें तो वह बाद में लौटेगा; चूक जाएँ तो नीचे गिरकर कल लौट आएगा।',
  'review.dashTitle': 'समीक्षा कतार',
  'review.dashDue': '{count} की समीक्षा बाक़ी',
  'review.dashDueOne': '1 की समीक्षा बाक़ी',
  'review.dashNone': 'आज कुछ बाक़ी नहीं',
  'review.dashHint': 'कमज़ोर कुंजियाँ और शब्द, ऐसे शेड्यूल किए गए कि सुधरी चीज़ें बार-बार न लौटें।',
  'review.open': 'कतार खोलें',
  'review.drillTitle': 'समीक्षा ड्रिल',

  // मांग के अनुसार अभ्यास गद्यांश बनाना (core/passage)
  'generate.title': 'गद्यांश बनाएँ',
  'generate.hint':
    'चुनी गई टाइपिंग कठिनाई के अनुसार लिखा गद्यांश। हर परिणाम उसी स्कोरर से मापा जाता है जो लाइब्रेरी उपयोग करती है — जो लिखा है, वही मिलेगा।',
  'generate.difficulty': 'कठिनाई',
  'generate.length': 'लंबाई',
  'generate.words': '{count} शब्द',
  'generate.topic': 'विषय (वैकल्पिक)',
  'generate.topicPlaceholder': 'जैसे भारतीय संविधान, बैंकिंग, रेलवे',
  'generate.action': 'बनाएँ',
  'generate.working': 'लिखा जा रहा है…',
  'generate.again': 'फिर कोशिश करें',
  'generate.use': 'यही गद्यांश लें',
  'generate.measured': 'मापा गया',
  'generate.offTarget': 'इससे ज़्यादा पास नहीं पहुँचा — {band} बिलकुल नहीं',
  'generate.failed': 'गद्यांश नहीं बनाया जा सका।',
  'generate.privacy':
    'आपकी कठिनाई और विषय आपके कॉन्फ़िगर किए AI प्रदाता को भेजे जाते हैं। गद्यांश इस डिवाइस के बाहर कहीं संग्रहीत नहीं होता।',

  // कार्य-पट्टियों का आकार बदलना, और फ़ील्ड के नीचे प्रगति पट्टी
  'exam.resizeLabel': 'अनुच्छेद और टाइपिंग क्षेत्र का विभाजक',
  'exam.resizeHint': 'टाइपिंग क्षेत्र का आकार बदलने के लिए खींचें · रीसेट के लिए डबल-क्लिक करें',
  'exam.showInput': 'टाइपिंग बॉक्स',
  'exam.hideInput': 'टाइपिंग बॉक्स',
  'exam.showInputHint': 'टाइपिंग फ़ील्ड दिखाएँ',
  'exam.hideInputHint':
    'टाइपिंग फ़ील्ड छिपाएँ और सीधे अनुच्छेद में टाइप करें — वहाँ का कर्सर और रंग वही बात दिखाते हैं',
  ...
  'dictate.subtitle':
    'जो शब्द आप बार-बार ग़लत करते हैं, वही एक-एक कर घड़ी के साथ। पट्टी ख़त्म होने से पहले टाइप कर दें।',
  'dictate.newBatch': 'नया बैच',
  'dictate.options': 'विकल्प',
  'dictate.optionsTitle': 'ड्रिल विकल्प',
  'dictate.viewLabel': 'दिखाएँ',
  'dictate.viewHint': 'एक अकेला शब्द, या पूरा बैच एक पंक्ति में जिस पर आगे बढ़ते जाएँ।',
  'dictate.viewWord': 'एक शब्द',
  'dictate.viewLine': 'पूरी पंक्ति',
  'dictate.timedLabel': 'हर शब्द पर समय',
  'dictate.timedHint': 'समय ख़त्म हुआ तो शब्द ग़लत गिना जाएगा, वर्तनी की ग़लती की तरह।',
  'dictate.limitLabel': 'प्रति शब्द सेकंड',
  'dictate.limitHint': 'असली अनुच्छेद में एक शब्द को लगभग तीन सेकंड ही मिलते हैं।',
  'dictate.shuffleLabel': 'बैच का क्रम बदलें',
  'dictate.shuffleHint': 'क्रम याद करके टाइप न करें, इसलिए हर बार अलग क्रम।',
  'dictate.batchLabel': 'प्रति बैच शब्द',
  'dictate.batchHint': 'अगले बैच से लागू होगा।',
  'dictate.timeLeft': '{sec}से',
  'dictate.timeUp': 'समय ख़त्म।',
  'dictate.timerAria': 'इस शब्द पर बचा समय',
  'dictate.empty':
    'अभी कोई ग़लती दर्ज नहीं है, इसलिए अभ्यास के लिए कुछ नहीं। एक टेस्ट दें — जो चूकेंगे, वह अपने आप यहाँ आ जाएगा।',
  ...
  'dictate.typeBody': 'टाइप करें, फिर स्पेस या Enter दबाएँ।',
  'dictate.holdBody': 'यही सही वर्तनी है। तैयार हों तो आगे बढ़ें।',
  'dictate.inputLabel': 'वर्तनी लिखें',
  'dictate.inputPlaceholder': 'शब्द टाइप करें…',
  ...
  'dictate.cardHint':
    'वही कमज़ोर शब्द, एक-एक कर तीन सेकंड की घड़ी के साथ — वर्तनी सोचने के लिए कोई वाक्य नहीं।',
  ...
  'changelog.paperMistakes':
    'काग़ज़ वाले रन की वर्तनी ग़लतियाँ अब ट्रेनर, समीक्षा कतार और श्रुतलेख अभ्यास तक पहुँचती हैं।',
  'changelog.countIn':
    'टेस्ट अब घड़ी चलने से पहले तीन, दो, एक गिनता है, ताकि रन के पहले सेकंड होम रो ढूँढ़ने में न जाएँ। तुरंत शुरू करना हो तो सेटिंग्स में इसे बंद कर दें।',
  'changelog.splitOptional':
    'लंबा आयात अब आपसे पूछे बिना अनुच्छेदों में नहीं बँटता — वह पूरा आता है, और बाँटना एक स्विच है जिसे आप चाहें तब दबाएँ।',
  'changelog.infoHints':
    'किसी नियंत्रण के पास का छोटा "i" बताता है कि वह क्या करता है — कर्सर रखने या टैप करने पर — पैनल पर हमेशा पड़े अनुच्छेद के बजाय।',
  'changelog.drillTimed':
    'श्रुतलेख अभ्यास अब हर शब्द बोलने के बजाय दिखाता है, और उसे घड़ी से बाँधता है — डिफ़ॉल्ट तीन सेकंड, एक-एक शब्द या पूरा बैच एक पंक्ति में, और सब कुछ पेज पर ही बदला जा सकता है।',
  'changelog.examClientColours':
    'परीक्षा-सॉफ़्टवेयर स्किन अब टाइपिंग बॉक्स और उसकी पट्टियाँ क्लाइंट के अपने रंगों में रंगती है, आपकी थीम जो भी हो — स्लेटी परीक्षा विंडो में काला बॉक्स नहीं।',
  'changelog.examSelectAll':
    'रन के दौरान सेलेक्ट-ऑल, अनडू और कट अस्वीकार हैं: एक ग़लत \u2318A अब आपका पूरा टाइप किया मिटा नहीं सकता।',
  'changelog.submitTimeout':
    'जमा करना अब अटक नहीं सकता। वर्तनी और व्याकरण जाँच को समय-सीमा दी गई है, और आपका परिणाम उनके उत्तर पर निर्भर नहीं है।',
  'changelog.motivation':
    'कट-ऑफ़ से नीचे रहे रन पर चुप्पी नहीं — एक कथन और थोड़ी हँसी-मज़ाक मिलती है।',
  'changelog.confetti':
    'किसी बोर्ड का कट-ऑफ़ पार करें, या बिना एक भी ग़लती रन पूरा करें — परिणाम स्क्रीन रंगीन कतरनें उड़ाती है।',
