...
export const en = {
  ...
  'exam.continuousOn': 'Continuous',
  'exam.continuousJoined': '+{count} joined',
  'exam.continuousHint':
    'Continuous mode: when this passage runs out, the next paragraph in your library is joined onto it.',
  ...
  'result.nextFromLibrary': 'Next from library',
  ...
  'setup.continuous': 'Continuous typing',
  'setup.continuousHint':
    'Do not stop at the end of the passage — join the next paragraph from your library onto it and keep going, so the clock ends the run instead of the paragraph.',
  ...
  'practice.todayTime': '{time} typed today',
  'practice.timeTitle': 'Time at the keyboard',
  'practice.today': 'Today',
  'practice.allTime': 'All time',
  'practice.testCount': '{count} tests',
  'practice.perDay': 'Minutes typed · last {days} days',
  'practice.peakDay': 'Best day {time}',
  'practice.perActiveDay': '{time} on an average practice day, across {days} days practised.',
  'practice.noneYet': 'No practice recorded yet — your first test starts the count.',
  ...
  'report.lead':
    'Tell us what happened. It opens as an issue on GitHub, which you read over and submit yourself — nothing is sent in the background.',
  'report.close': 'Close',
  ...
  'report.namePlaceholder': 'So we know who to reply to',
  'report.required': 'Required',
  'report.message': 'What happened',
  'report.messagePlaceholder':
    'What you did, what you expected, and what happened instead.',
  'report.messageMin': 'At least {count} characters — a sentence or two is plenty.',
  'report.messageCount': '{count} characters left',
  'report.contact': 'Email or handle',
  'report.contactPlaceholder': 'Only if you want a reply outside GitHub',
  'report.attached': 'Sent with your report',
  'report.attachedLine':
    'Typly {version} ({build}) · interface {lang} · browser and runtime versions. No passages, results or personal data.',
  'report.publicWarning': 'A GitHub issue is public. Leave out anything you would not post.',
  'report.open': 'Open on GitHub',
  'report.copy': 'Copy report',
  'report.copied': 'Report copied.',
  'report.copyFailed': 'Could not copy — select the text and copy it by hand.',
  'report.needBoth': 'Your name and a message are both needed.',
  'report.opened': 'GitHub is open — press Submit there to file it.',
  'report.openedTrimmed':
    'GitHub is open, and the full report is on your clipboard — paste it in if anything is missing.',
  'report.blocked': 'The browser blocked the new tab. Copy the report and open GitHub yourself.',
  'report.blockedCopied':
    'The browser blocked the new tab, so the report is on your clipboard — paste it into a new GitHub issue.',
